...
export default function BackToTopButton() {
    ...
    return (
        <button
            onClick={scrollToTop}
            className="fixed bottom-6 right-6 bg-[#A4B350] text-white w-12 h-12 flex items-center justify-center rounded-full shadow-lg hover:bg-[#666666] transition-colors z-50 cursor-pointer"
